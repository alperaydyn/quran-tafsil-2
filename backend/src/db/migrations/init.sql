-- ══════════════════════════════════════════════════════════════════════
-- tafsil.net — Master PostgreSQL 16+ Database Schema
-- ══════════════════════════════════════════════════════════════════════
...
-- Full-Text Search (GIN) İndeksleri (Türkçe arama hızlandırma)
...
-- pgvector HNSW İndeksleri (Semantik Kosinüs Benzerliği)
